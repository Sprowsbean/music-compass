    ...
    <Page>
      <div style={{ textAlign: 'center', paddingTop: '4rem' }}>
        ...
        <p style={{ color: '#4a4870', fontFamily: 'DM Mono', lineHeight: 1.8, maxWidth: 480, margin: '0 auto 2.5rem' }}>
          ...
          <b>Supabase & Kaggle</b> databases — unknowns scored by Gemini AI.<br />
      ...
      <div style={{ marginTop: '5rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(160px,1fr))', gap: 12 }}>
          {[
            ...
            { n: '03', title: 'Database', body: 'Match track name → get exact energy & valence from DB' },
            { n: '04', title: 'Gemini',   body: 'Predict missing songs calibrated to cosmic scale' },
          ...
          <div className="nebula-card" style={{ padding: '24px 28px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(110px,1fr))', gap: 12 }}>
              {[
                ...
                { label: 'LISTENING TIME', val: `${Math.round(selectedUser.totalMs / 3_600_000)}h`, col: '#fbbf24' },
                { label: 'DATABASE (DB)',  val: selectedUser.stats.kaggle + selectedUser.stats.fuzzy + selectedUser.stats.supabase, col: '#00e5ff' },
  ...
  return (
    <div>
      ...
      <footer style={{ borderTop: '1px solid rgba(79,70,229,0.2)', textAlign: 'center', padding: '20px', fontFamily: 'DM Mono', fontSize: 9, letterSpacing: '0.15em', color: '#2a2848' }}>
        MUSIC COMPASS · DATABASE (DB) · GOOGLE GEMINI AI
      </footer>
    </div>
  );
}
